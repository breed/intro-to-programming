...
`fs::path::operator<<` *quotes* its output to handle paths that contain spaces or special characters --- so `cout << p` prints `"/home/user/music/playlist.m3u"`, not `/home/user/music/playlist.m3u`.
